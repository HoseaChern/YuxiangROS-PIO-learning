...
| 直立环参数 | `BALANCE_KP`、`BALANCE_KI`、`BALANCE_KD`、`BALANCE_PWM_LIMIT`、`BALANCE_ZERO_PITCH_DEG`                                                                                          | 直立环 PD 标定与机械中值              |
| 安全与标定 | `BALANCE_ARM_ANGLE_DEG`、`BALANCE_FALL_ANGLE_DEG`、`BALANCE_CALM_DELAY_MS`、`BALANCE_CALIB_CYCLES`、`BALANCE_PRINT_MS`                                                           | 起控/倒地保护阈值、中值标定、打印周期 |
